...
void Vsimtop___024root___eval_triggers__act(Vsimtop___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(2U, (((IData)(vlSelf->simtop__DOT__pvr__DOT__isp_parser_inst__DOT__x_ps) 
                                      != (IData)(vlSelf->__Vtrigprevexpr___TOP__simtop__DOT__pvr__DOT__isp_parser_inst__DOT__x_ps__0)) 
                                     | ((IData)(vlSelf->simtop__DOT__pvr__DOT__isp_parser_inst__DOT__y_ps) 
                                        != (IData)(vlSelf->__Vtrigprevexpr___TOP__simtop__DOT__pvr__DOT__isp_parser_inst__DOT__y_ps__0))));
